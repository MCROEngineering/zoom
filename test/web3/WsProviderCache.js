...
var WsProviderCache = /** @class */ (function () {
    ...
    */
    ...
    WsProviderCache.prototype.saveToCache = function (val) {
        this.savetocache = val;
    };
    WsProviderCache.prototype.useCache = function (val) {
        this.usecache = val;
    };
    /**
     ...
     * @param boolean
     */
    WsProviderCache.prototype.enableCache = function (setting) {
     ...
     * @param {object}
     */
    WsProviderCache.prototype.setCache = function (data) {
        this.cache = data;
    };
    /**
     ...
     */
    WsProviderCache.prototype.fromCache = function (payload) {
        var cacheKey = this.getCacheKey(payload);
        return {
     ...
     * @returns {result} cached rpc result
     */
    WsProviderCache.prototype.fromCacheByKey = function (cacheKey, payload) {
        return {
            jsonrpc: payload.jsonrpc,
            id: payload.id,
            result: this.cache[cacheKey]
     ...
     * @returns boolean
     */
    WsProviderCache.prototype.inCache = function (payload) {
        var cacheKey = this.getCacheKey(payload);
     ...
     * @returns boolean
     */
    WsProviderCache.prototype.inCacheByKey = function (cacheKey) {
        if (this.cache.hasOwnProperty(cacheKey)) {
            return true;
        }
        return false;
     ...
     */
    WsProviderCache.prototype.toCache = function (payload, result) {
     ...
     */
    WsProviderCache.prototype.getCacheKey = function (payload) {
        var key;
        if (payload.length > 1) {
